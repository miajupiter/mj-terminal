...
const getInfo = () => {
  ...
  message += `<span style="color: ${mainColor}">Author</span>: ${packageJson.author}\n`
  message += `<span style="color: ${mainColor}">Web Site</span>: <a href="https://miajupiter.com" target="_blank">miajupiter.com</a>\n`
